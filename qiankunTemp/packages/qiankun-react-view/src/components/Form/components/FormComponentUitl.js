...
import JumpChooseInput from './JumpChooseInput'
...
export default function getComponentByType(item) {
  ...
  if (item.componentType === 'password') {
    return (
      <Input.Password
        placeholder=''
      // placeholder={item.props.disabled ? '' : (item.placeholder || item.label)} 
      />
    )
  }
  ...
  if (item.componentType === 'jumpChooseInput') {
    return (
      <JumpChooseInput
        placeholder=''
        // placeholder={(item.props && item.props.disabled) ? '' : (item.placeholder || item.label)}
  ...
  if (item.componentType === 'rangerPicker') {
    return <RangePicker
      // placeholder={(item.props && item.props.disabled) ? '' : (item.placeholder || item.label)} {...item.props} 
      placeholder=''
      style={{ width: '100%' }}
      {...item.props}
    />;
  ...
  if (item.componentType === 'optionSelect') {
    return <OptionSelect
     {...item.props}
      placeholder=''
    //  placeholder={(item.props && item.props.disabled) ? ' ' : null} 
    />;
  }
  ...
  if (item.componentType === 'treeSelect') {
    return (
      <TreeSelect
        ...
        placeholder=''
        // placeholder={(item.props && item.props.disabled) ? '' : (item.placeholder || item.label)}
        searchPlaceholder={(item.props && item.props.disabled) ? '' : (item.placeholder || item.label)}
        {...item.props}
        style={{ width: '100%' }}
        dropdownStyle={{
          maxHeight: 500,
